...
if( $restaurant_logo != '' ){
$email_template2 .='<img align="left" alt="" class="kmImage" src="'.$restaurant_logo.'" width="228" style="border: 0; height: auto; line-height: 100%; outline: none; text-decoration: none; padding-bottom: 0; display: inline; vertical-align: bottom; margin-right: 0; max-width:274px;" />';
}
...
$email_template2 .='<p style="margin: 0; text-align: right;"><span style="color:#000000;">'.$restaurant_address.'</span></p>';
}

if( $restaurant_address != '' ){
	$email_template2 .='<p style="margin: 0; text-align: right;">';
	
		if( $restaurant_city != '' ){
			$email_template2 .='<span style="color:#000000;">'.$restaurant_city.', </span>';
		}
		
		if( $restaurant_state != '' ){
			$email_template2 .='<span style="color:#000000;">'.$restaurant_state.'</span>';
		}
		
		if( $restaurant_zipcode != '' ){
			$email_template2 .='<span style="color:#000000;"> '.zipcode.'</span>';
		}
	$email_template2 .='</p>';
}

if( $restaurant_phone != '' ){
$email_template2 .='<p style="margin: 0; text-align: right;"><span style="color:#000000;">Tel: '.$restaurant_phone.'</span></p>';
}
if( $restaurant_fax != '' ){
$email_template2 .='<p style="margin: 0; text-align: right;"><span style="color:#000000;">Fax: '.$restaurant_fax.'</span></p>';
}
if( $restaurant_email != '' ){
$email_template2 .='<p style="margin: 0; text-align: right;"><a href="'.$restaurant_email.'">'.$restaurant_email.'</a></p>';
}
if( $restaurant_website != '' ){
$email_template2 .='<p style="margin: 0; text-align: right;"><a target="_blank" href="http://'.$restaurant_website.'" style="word-wrap: break-word; color: #0000CD; font-weight: normal; text-decoration: underline">'.$restaurant_website.'</a></p>';
}
if( $restaurant_offer_link != '' || $restaurant_reservation_link != '' ){
	$email_template2 .='<p style="margin: 0; padding-bottom: 0; text-align: right;"><span style="color:#000000;">'; 
		if( $restaurant_offer_link != '' ){
			$email_template2 .='<a target="_blank" href="http://'.$restaurant_offer_link.'">Special Offers</a></span>'; 
		}
	
		if( $restaurant_offer_link != '' && $restaurant_reservation_link != '' ){
			$email_template2 .='<span style="color:#000000;"> | </span>'; 
		}
		if( $restaurant_reservation_link != '' ){
			$email_template2 .='<a target="_blank" href="http://'.$restaurant_reservation_link.'">Reservations</a>';
		}					
	$email_template2 .='</p>';
} // if( $restaurant_offer_link != '' || $restaurant_reservation_link != '' ){
$email_template2 .='
...
if( $restaurant_image != '' ){
$email_template2 .='<img align="center" alt="" class="kmImage" src="'.$restaurant_image.'" width="500" style="border: 0; height: auto; line-height: 100%; outline: none; text-decoration: none; padding-bottom: 0; display: inline; vertical-align: bottom; width:100%;" />';
}
...
<p style="margin: 0; padding-bottom: 0"><span style="font-size:26px;"><strong>'.$subject2.'</strong></span></p>
</td>
</tr>
</tbody>
</table>
...
$email_template2 .= 	$restaurant_message;
} // if( $restaurant_message != '' ){
