						...
						if( $success ){ // INSERT POST 
							...
							if( $send_email_to_owner ) {
								...
								if( $owner_email != '' ){
									...
									================================================*/
										...
										require_once( $plugin_path . 'restaurant reservation/email-content1.php');
							...
							if( $send_email_to_customer ) {
								...
								if( $customer_email != '' ){
									...
									//= 2.	SUBJECT
									$subject2 = $customer_email_subject;
									...
									================================================*/
										...
										require_once( $plugin_path . 'restaurant reservation/email-content2.php');
									...
									if( $_SERVER['HTTP_HOST'] != 'localhost' ){
										$result  = mail($recipient,$subject2, $messages,$headers);
										if( $result ){
											echo "<br />";
